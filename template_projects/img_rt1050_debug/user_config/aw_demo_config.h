...
#define DE_HWTIMER_NAME                 "imx1050_gpt"       /* gpt定时器名称 */
...
#define DE_NANDFLASH_DEV_NAME           "awbl_imx1050_nandflash_drv_name"
#define DE_NAND_FLASH_DEV_ID            1

#define DE_OTP_MEM                      "otp_osp"/* otp存储段名称和单元号，在awbl_hwconf_imx1050_ocotp.h 中查看修改  */
#define DE_NAND_NAME                    "/dev/mtd0" /* nandflash存储段名称*/

#define DE_DISK_NAME                    "/dev/mtd0"
...
#define DE_SPI_DEV_BUSID                0/* SPI总线ID*/

#define DE_SPI_CS_PIN                   GPIO1_28/* SPI片选引脚*/

#define DE_FLEXSPI_NVRAM_NAME          "user_data"

#define DE_USB_BLK_NAME                 "/dev/h1-d1-0"/* USB块设备名字*/
