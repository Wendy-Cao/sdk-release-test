...
..\..\common_tools\dcd_and_imx\mk_flexspi_nor_boot_srec2imx.exe %firmware_name%.srec %firmware_name%_nopadding.imx
...
..\..\common_tools\bin\cfimager.exe -raw -offset 0x400 -f easy_arm_rt1052_flash_burn.imx -d %diskpath%
